...
TEXTS = {
    "uz": {
        ...
        "terms_missing": "Hozircha PDF fayl joylanmagan. Keyinchalik foydalanish shartlari <code>{path}</code> manziliga qo'yiladi.",
    ...
    "ru": {
        ...
        "terms_missing": "PDF-файл пока не размещен. Позже условия использования будут размещены по адресу <code>{path}</code>.",
    ...
    "en": {
        ...
        "terms_missing": "The PDF file has not been uploaded yet. The Terms of Use will later be placed at <code>{path}</code>.",
